...
router.get('/run', function(req,res,next){
  var addr = www.ManagerContractAddress;
  res.render('run', {title: 'Dapp Water', manager_address: addr.toString('hex'), oracle_abi_link: www.oracleAbi, manager_abi_link: www.ManagerAbi, proposal_abi_link: www.ProposalAbi, proposal_bytecode: www.ProposalCompile.bytecode, oracle_address: www.WaterOracleAddress});
});
